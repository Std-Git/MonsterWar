...
namespace engine::loader
{
    ...
    private:
        ...
        int current_layer_ = 0;                     ///< @brief 当前图层序号 (用于 RenderComponent 决定渲染顺序)
    ...
    private:
        ...
        /**
         * @brief 加载 Tiled tileset 文件 (.tsj),数据保存到 tileset_data_;
        ...
        /**
         * @brief 获取瓦片属性
         * @tparam T 属性类型 (如 bool, string)
         * @param tile_json 瓦片 json 数据
        ...
        /**
         * @brief 根据瓦片 json 对象获取瓦片类型（当前项目中，TileType无任何作用）
         * @param tile_json 瓦片 json 数据
         * @return 瓦片类型
         */
        ...
        /**
         * @brief 根据图块集中的 id 获取瓦片类型（当前项目中，TileType无任何作用）
         * @param tileset_json 图块集 json 数据
         * @param local_id 图块集中的 id
         * @return 瓦片类型
         */
         ...
         */
        std::optional<engine::component::TileInfo> getTileInfoByGid(int gid); // gid = global id

        /**
         * @brief 解析图片路径，合并地图路径和相对路径
