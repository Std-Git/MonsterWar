...
protected:
    ...
    // 解析游戏对象所需要的关键信息
    const nlohmann::json* object_json_ = nullptr;               ///< @brief 来自.tmj 地图文件的对象数据
    const engine::component::TileInfo* tile_info_ = nullptr;    ///< @brief 来自.tsj 的瓦片数据
...
protected:
    ...
    // --- 代理函数，让子类能够获取到 LevelLoader 的私有方法 ---
    template <typename T>
