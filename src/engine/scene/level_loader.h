...
namespace engine::scene
{
    ...
    public:
        ...
        /**
         * @brief 加载关卡数据到指定的 Scene 中
         * @param map_path Tiled JSON 地图文件的路径
         * @param scene 要加载关卡数据的目标 Scene 对象
         * @return bool 是否加载成功
         */
    ...
    private:
         ...
         * @param anim_json 动画 json 数据 (自定义)
         ...
         * @param sound_json 音效 json 数据 (自定义)
         ...
         */
        engine::component::TileInfo getTileInfoByGid(int gid); // gid = global id

        /**
         * @brief 根据全局 id 或取瓦片 json 对象 (用于对象层获取瓦片信息)
         * @param gid 瓦片全局 id
         * @return 瓦片 json 对象
         */
         ...
         * @param tileset_path Tileset 文件的路径
