...
struct Sprite
{
    ...
    engine::utils::Rect src_rect_{};            ///< @brief 源矩形(为了保证效率，不使用 std::optional, 构造时必须提供)
     ...
     * @param is_flipped 是否翻转，默认为 false
     */
...
struct SpriteComponent
{
     ...
     * @param size 大小
     * @param offset 偏移
     * @param is_visible 是否可见, 默认为 true
     */
