...
namespace engine::core
{
    ...
    /**
     * @brief 持有对核心引擎模块的上下文对象
     *
     * 用于简化依赖注入，传递 Context 即可获取引擎的各个模块
     */
    class Context final
    {
    private:
        // 使用引用，确保各个模块都有效，使用是不需要检查各个指针是否为空
        ...
        engine::render::Camera &camera_;                      ///< @brief 摄像机
    ...
    public:
        ...
        engine::render::Camera &getCamera() const { return camera_; };                               ///< @brief 获取摄像机
